...
const FALLBACK = {
  en: {
    ...
    enrollment_complete_title: "Enrollment complete",
    enrollment_complete_sub: "Save or share your enrollment receipt below.",
    ...
    print_popup_blocked: "Allow pop-ups to print this document",
  ...
  hi: {
    ...
    enrollment_complete_sub: "नीचे अपनी पंजीकरण रसीद प्रिंट या साझा करें।",
    enrollment_receipt: "पंजीकरण रसीद",
    enrollment_status: "पंजीकरण स्थिति",
    ...
    print: "प्रिंट",
    print_all: "सभी प्रिंट",
    share: "साझा करें",
    share_whatsapp: "WhatsApp",
    share_email: "ईमेल",
    copy: "कॉपी",
    copied: "क्लिपबोर्ड में कॉपी हो गया",
    print_popup_blocked: "प्रिंट के लिए पॉप-अप की अनुमति दें",
