...
const DEFAULT_AGREEMENTS = [
  {
    ...
    required: true,
    content: "By using buildecogroup.com you agree to use the marketplace, tenders, and tools lawfully.",
    content_hi: "buildecogroup.com उपयोग करने पर आप मार्केटप्लेस, टेंडर और टूल्स का कानूनी उपयोग करने के लिए सहमत हैं।",
  },
  {
    code: "privacy_policy",
    version: "1.0",
    ...
    required: true,
    content: "We collect name, email, phone, and location to operate the platform. We do not sell personal data.",
    content_hi: "प्लेटफ़ॉर्म चलाने के लिए नाम, ईमेल, फ़ोन और लोकेशन ली जाती है। व्यक्तिगत डेटा नहीं बेचा जाता।",
  },
];
...
export default function Enrollment() {
  ...
  useEffect(() => {
    api.get("/enrollment/agreements", { params: { mode, user_type: userType } })
      .then(({ data }) => setAgreements(Array.isArray(data) && data.length ? data : DEFAULT_AGREEMENTS))
      .catch(() => setAgreements(DEFAULT_AGREEMENTS));
  }, [mode, userType]);
