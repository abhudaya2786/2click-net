...
import { Gavel, Store, Sun, Building2, Bot, Truck, Boxes, Calculator, ArrowUpRight, Clock, Users, Compass, ClipboardList, FileText } from "lucide-react";
...
const SERVICES = [
  ...
  { icon: Building2, t: "Construction ERP + Mera Ghar", d: "BOQ calculators, home build lifecycle, agreements, milestone payments and project control.", to: "/dashboard", cta: "Open workspace" },
  ...
  { icon: Calculator, t: "Super Mart + Material BOQ", d: "Live brand-wise material rates, 1-click BOQ templates and contractor ERP integration.", to: "/mart", cta: "Open Super Mart" },
  { icon: ClipboardList, t: "Interior & Finishing BOQ", d: "Category-wise calculators: tiles, false ceiling, PVC, renovation, gardening — brand-wise pricing.", to: "/interior-boq", cta: "Interior BOQ" },
  { icon: Compass, t: "Consultant Panel", d: "Exterior, interior, architect, vastu consultants — filter by role and experience.", to: "/consultants", cta: "Find consultants" },
  { icon: Users, t: "Freelancers & Professionals", d: "Architects, engineers, CAs — browse, enquire and book with platform commission.", to: "/freelancers", cta: "Hire freelancers" },
  ...
  return (
    <div className="mx-auto max-w-[1400px] px-5 md:px-10 py-16 md:py-24">
      ...
      <div className="max-w-2xl mb-14">
        ...
        <p className="mt-4 text-muted-foreground">A modular suite covering procurement, projects, finance, energy, consultants and intelligence. Tap any capability to jump straight in.</p>
      </div>
      ...
      <div className="mt-20 border-t border-border pt-16">
        <h2 className="font-display font-extrabold text-2xl md:text-3xl tracking-tight mb-2">Quick access — all tools</h2>
        <p className="text-sm text-muted-foreground mb-8">Jump directly to any module on the platform.</p>
        <PlatformToolsGrid compact />
      </div>
    </div>
  );
}
